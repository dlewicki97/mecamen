                    ...
                    <div class="row"> <!-- set -->
                        ...
                        <div class="col-md-12 pr-0">
                            <div class="form-group bd-t-0-force">
                                ...
                                <input class="form-control" id="work_place" type="text" value="<?php echo $value->work_place; ?>" readonly>
                            </div>
                        </div><!-- col-12 -->
                        <div class="col-md-12 pr-0">
                            <div class="form-group bd-t-0-force">
                                <label class="form-control-label">Miejsce pracy:</label>
                                <input class="form-control" id="city" type="text" value="<?php echo $value->city; ?>" readonly>
                            </div>
                        </div><!-- col-12 -->
                    </div> <!-- set -->
                    <div class="row"> <!-- set -->
    ...
    <script type="text/javascript">
      function sendMessage(id)
      {
        ...
        var work_place = '<?= $value->work_place ?>';
        var city = '<?= $value->city ?>';
        if(subject == '') {
            alert('Proszę wypełnić temat!');
            return;
        } 
         if(message == '') {
            alert('Proszę wypełnić wiadomość!');
            return;
        } 

        $.ajax({  
             type: "post", 
             url:"<?php echo base_url(); ?>panel/job_applications/send", 
             data: {id: id, subject: subject, message: message, email: email, work_place: work_place, city: city}, 
             cache: false,
