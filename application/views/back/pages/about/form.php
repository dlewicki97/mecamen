            ...
            <div class="row no-gutters">
                <div class="col-md-8">
                    <div class="row"> <!-- set -->
                        ...
                        <div class="col-md-12 pr-0">
                            <div class="form-group bd-t-0-force">
                                <label class="form-control-label">Tytuł 2 (opcjonalnie): </label>
                                <input class="form-control" type="text" name="title2" value="<?php echo @$value->title2; ?>" >
                            </div>
                        </div><!-- col-4 -->
                        <div class="col-md-12 pr-0">
                            <div class="form-group bd-t-0-force ">
                                <label class="form-control-label">Opis 2 (opcjonalnie):</label>
