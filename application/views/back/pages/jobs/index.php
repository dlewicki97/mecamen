            ...
            <table id="datatable1" class="table display responsive nowrap">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="align-middle"><?php echo substr($value->work_place, 0, 70); if(strlen($value->work_place) > 70) echo '...' ?></td>
                  <td class="text-right">
                      ...
                      onclick="return confirm('Czy na pewno chcesz usunąć <?php echo $value->work_place; ?>? #<?php echo $value->id; ?>')" >
