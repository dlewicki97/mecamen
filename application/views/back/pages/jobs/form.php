                    ...
                    <div class="row"> <!-- set -->
                        <div class="col-md-12 pr-0">
                            <div class="form-group bd-t-0-force  ">
                                <label class="form-control-label">Napis na przyciski:</label>
                                <input class="form-control" name="button_name" value="<?php echo @$value->button_name; ?>">
                            </div>
                        </div><!-- col-4 -->
                        <div class="col-md-12 pr-0">
                            <div class="form-group bd-t-0-force bd-b-0-force ">
                                <label class="form-control-label">Opis oferty:</label>
