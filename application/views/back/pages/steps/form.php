                    ...
                    <div class="row"> <!-- set -->
                        ...
                        <div class="col-md-12 pr-0">
                            <div class="form-group bd-r-0-force bd-t-0-force">
                                ...
                                <textarea class="form-control" type="text" name="subtitle" ><?php echo @$value->subtitle; ?></textarea>
                            </div>
                        </div><!-- col-4 -->
                        <div class="col-md-12 pr-0">
                            <div class="form-group bd-r-0-force bd-t-0-force">
                                <label class="form-control-label">Krok:</label>
                                <input class="form-control" type="text" name="step" value="<?php echo @$value->step; ?>">
                            </div>
                        </div><!-- col-4 -->
                    </div> <!-- set -->
