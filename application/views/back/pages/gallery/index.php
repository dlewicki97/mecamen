      ...
      <div class="br-pagebody mg-t-0 pd-x-30">
                      ...
                      <?php foreach ($rows as $value): ?>
                        <div class="col-lg-4 col-md-6 text-center mb-3 align-self-center">
                          ...
                          <div class="input-group">
                            ...
                            border-bottom-left-radius: 3px;" type="text" class="form-control p-2" id="getOrder<?= $value->id ?>" name="menu_order" placeholder="Kolejność" onchange="changeOrder(<?= $value->id ?>)" value="<?= @$value->menu_order ?>">
                          </div>
                        </div>
                      <?php endforeach; ?>
                    </div>
        ...
        <script type="text/javascript">
          function changeOrder(id) {
            ...
            $.ajax({
              type: "post",
              url: "<?= base_url() ?>panel/settings/menu_order",
              data: {
                id: id,
