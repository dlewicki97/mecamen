                    ...
                    <div class="row"> <!-- set -->
                        <div class="col-md-12 pr-0">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="date" value="<?php echo @$value->date; ?>" required>
                            </div>
                        </div><!-- col-4 -->
                        <div class="col-md-12 pr-0">
                            <div class="form-group bd-t-0-force ">
                                <label class="form-control-label">Opis:</label>
                                <input class="form-control" type="text" name="description" value="<?php echo @$value->description; ?>">
                            </div>
                        </div><!-- col-4 -->
